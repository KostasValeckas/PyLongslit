...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Convert air wavelengths to vacuum wavelengths.')
    parser.add_argument('infile', type=str, help='Input file containing wavelengths in air.')
    parser.add_argument('outfile', type=str, help='Output file containing wavelengths in vacuum.')
    ...
    for row in data:
        ...
        ions.append(ion)
        print(f'{ion}. Air: {air_wavelength} Angstroms -> Vacuum: {vac_wavelength:.6f} Angstroms')
