...
ax1.imshow(
    image[
        ...
        NAXIS1
        - cen2d
        - int(normrange / abs(hdr["CDELT1"])) : NAXIS1
        - cen2d
        + int(normrange / abs(hdr["CDELT1"])),
    ],
    cmap=cm.gray_r,
    vmin=medianbk - 3 * sigmabk,
    vmax=medianbk + 10 * sigmabk,
    aspect="auto",
    origin="lower",
)
...
ax2.set_ylim(-2.0 * sig1d, 1.1 * mean1d + 9.0 * sig1d)
