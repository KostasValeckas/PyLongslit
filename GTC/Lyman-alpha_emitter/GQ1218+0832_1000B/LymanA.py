...
Parameter_guesses = [np.max(spectrum), 3860., 100.]
...
plt.plot(np.linspace(3843., 3880.), gauss_function(np.linspace(3843., 3880.), *val), '-',c = '#fc5a50',\
         label='Gaussian fit')
plt.xlim(3830,3890)
plt.ylim(-5,22)
...
fwhm = np.sqrt(8.*np.log(2.))*val[2]
print('Peak wavelength '+"{:.6}".format(val[1])+' Å')
print('FWHM '+"{:.6}".format(fwhm)+' Å')
