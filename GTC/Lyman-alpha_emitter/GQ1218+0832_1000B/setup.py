...
IDtolerance = 5.0  # Tolerance for deleting lines in fitting arcdata.

# Parameters for REIDENTIFY
FITTING_MODEL_REID = "Chebyshev"  # 2-D fitting function
ORDER_SPATIAL_REID = 2
ORDER_WAVELEN_REID = 3
STEP_REID = 18  # Reidentification step size in pixels (spatial direction)
NSUM_REID = 18
TOL_REID = 8  # tolerence to lose a line in pixels
